...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-hNPkezxl.js");
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Zht4mv2_.js").then((n2) => n2.r),
...
var ROUTER_BASEPATH = "anime-oasis-51";
var SERVER_FN_BASE = "/anime-oasis-51/_serverFn/";
