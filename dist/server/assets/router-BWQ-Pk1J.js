...
function LanguageProvider({ children }) {
  const [lang, setLangState] = reactExports.useState("en-US");
  reactExports.useEffect(() => {
    try {
      const stored = localStorage.getItem("animedia:lang");
  ...
  reactExports.useEffect(() => {
    ...
    try {
      localStorage.setItem("animedia:lang", lang);
    } catch {
    }
  }, [lang]);
  const value = {
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.nav,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1600px] mx-auto px-4 md:px-8 flex items-center gap-3 md:gap-6 h-16 md:h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2 group shrink-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xl font-black tracking-tight hidden sm:block uppercase", children: [
              "ANIME",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gradient", children: "DIA" })
            ] })
          ] }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit, className: "hidden md:flex flex-1 max-w-md ms-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-4 h-4 absolute top-1/2 -translate-y-1/2 start-3 text-muted-foreground pointer-events-none" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                type: "search",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 ms-auto md:ms-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: lang === "en-US" ? "EN" : "AR" })
                ]
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 flex flex-col gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Search, { className: "w-4 h-4 absolute top-1/2 -translate-y-1/2 start-3 text-muted-foreground pointer-events-none" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "input",
                  {
...
const $$splitComponentImporter$5 = () => import("./tv-BVsA2ghD.js");
const Route$5 = createFileRoute("/tv")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "استمتع بمشاهدة أحدث حلقات الأنمي والأفلام العالمية بجودة عالية وسيرفرات سريعة."
    }, {
      property: "og:title",
      content: "Animedia — وجهتك الأولى للأنمي"
    }, {
      property: "og:description",
      content: "شاهد أفلامك ومسلسلاتك المفضلة في مكان واحد مع تجربة مشاهدة فريدة."
    }, {
      property: "og:image",
...
ZodOptional.create;
ZodNullable.create;
const $$splitComponentImporter$4 = () => import("./search-DBy_HRIx.js");
...
const $$splitComponentImporter$3 = () => import("./my-list-DMIIYwXq.js");
...
const $$splitComponentImporter$2 = () => import("./movies-CdK9UrX9.js");
...
const $$splitComponentImporter$1 = () => import("./index-CmYd5a9U.js");
...
const $$splitComponentImporter = () => import("./watch._id-BFoZzjEz.js");
const searchSchema = objectType({
  type: enumType(["tv", "movie"]).optional()
});
const Route2 = createFileRoute("/watch/$id")({
...
const MyListRoute = Route$3.update({
  id: "/my-list",
  path: "/my-list",
  getParentRoute: () => Route$6
});
const MoviesRoute = Route$2.update({
  id: "/movies",
  path: "/movies",
  getParentRoute: () => Route$6
});
...
const WatchIdRoute = Route2.update({
  id: "/watch/$id",
  path: "/watch/$id",
  getParentRoute: () => Route$6
});
