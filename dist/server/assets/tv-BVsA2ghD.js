...
import { F as FilterBar } from "./FilterBar-BlzQm-BT.js";
import { M as MediaGrid } from "./MediaGrid-GaSyHnnM.js";
import { d as discoverByFilters } from "./tmdb-CAXpkaUt.js";
import { u as useLanguage, m as motion } from "./router-BWQ-Pk1J.js";
...
function TvPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(motion.div, { initial: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-[1600px] mx-auto px-4 md:px-8 mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-4xl md:text-5xl font-black tracking-tight mb-2", children: t("tv") }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: t("discoverTv") })
    ] }),
